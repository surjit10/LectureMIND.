...
RELATION_EXTRACTION_PROMPT = (
    "Given the entities and lecture context, extract valid educational relationships.\n\n"
    "Rules:\n"
    "* Use entity_id references only (e.g. E1, E2)\n"
    ...
    "  Example: 'Alternating Current' PREREQUISITE_OF 'Transformer'\n"
    "  Strict Exclusion: PREREQUISITE_OF must NOT mean 'A causes B', 'B uses A', 'A is physically part of B', 'A appears before B', 'A explains B', 'A is mentioned near B', or 'A is involved in producing B'.\n"
    "  Negative Examples: Do NOT label physical materials/components ('Iron Core' -> 'Transformer'), operational side-effects/losses ('Eddy Currents' -> 'Transformer'), circuit variables ('Voltage' -> 'Transformer', 'Current' -> 'Transformer'), or physical waveforms ('Sinusoidal Waveform' -> 'Alternating Current') as PREREQUISITE_OF merely because they are related or used together.\n"
    "- INTRODUCED_BEFORE: Concept A is formally introduced earlier in the lecture narrative than B, "
    "establishing foundational terminology.\n"
    "- USED_BY: Entity A is an instrument, material, component, or property utilized by Entity B.\n"
    "  Example: 'Iron Core' USED_BY 'Transformer'\n"
    "- DERIVED_FROM: Concept A is mathematically, physically, or logically derived from Concept B.\n"
    "  Direction: A DERIVED_FROM B means B came first and A stems from B.\n"
    "  Example: 'Electromotive Force' DERIVED_FROM 'Magnetic Field'\n"
    "- VISUALIZED_BY: Concept A is depicted or demonstrated by visual diagram/aid B.\n"
    "- EXPLAINS: Concept A provides the theoretical mechanism explaining phenomenon B.\n\n"
    "Available entities:\n{entity_list}\n\n"
    "Lecture context:\n{context}\n\n"
    "Output format:\n"
